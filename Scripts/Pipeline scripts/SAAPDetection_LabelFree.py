...
#  Last updated 06-05-2026 by Alex Maropakis
...
fasta_path=scratch_dir+'Dependencies/FASTA/MOUSE_GENOME.fna'
frameshift_dir=scratch_dir+'Dependencies/frame_translations/mouse/'
...
W_aa_ambiguous = W1_aa_ambiguous = pickle.load(open(frameshift_dir + 'W1_aa_ambig.p' , 'rb'))
sa_ambiguous = sa1_ambiguous = pickle.load(open(frameshift_dir + 's1a_ambig.p', 'rb'))
