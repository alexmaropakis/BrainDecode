...
# --- standard genetic code (used only to flag exact_mutation, not to call AAs)-
CODON_TABLE = {
...
def main():
    ...
    ap.add_argument("--keep-csv", required=True)
    ap.add_argument("--gnomad-dir", required=True)
    ap.add_argument("--gene-bed", required=True)
    ap.add_argument("--out-dir", required=True)
    ap.add_argument("--prefix", default="Ping")
    a = ap.parse_args()
