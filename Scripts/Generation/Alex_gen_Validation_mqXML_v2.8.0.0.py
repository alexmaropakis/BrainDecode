...
"""
Generate MaxQuant XML file and SLURM script for v2.8.8.0 Validation search 
Last updated by: Alex Maropakis, 06-03-2026

Example usage:
python Alex_gen_Validation_mqXML_v2.8.0.0.py /home/maropakis.a/scripts/XML/templates/tmt10_MS3_v2.8.8.0_template.xml \
    /scratch/maropakis.a/MQ_raw/Ping_2018/ACG/b1/ \
    -o Ping2018_ACG_B1_Val.xml \
    -e Ping_2018 \
    -s acg_b1 \
    --partition short \
    -t 21
